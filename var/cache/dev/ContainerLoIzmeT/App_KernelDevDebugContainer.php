...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        return $this->privates['.messenger.handler_descriptor.3EVMizW'] = new \Symfony\Component\Messenger\Handler\HandlerDescriptor(($this->privates['App\\MessageBus\\MessageHandler\\GetFreelancerDetailsMessageHandler'] ?? $this->getGetFreelancerDetailsMessageHandlerService()), []);
    }
    ...
    {
        $this->privates['App\\Command\\GetAllFreelancerCommand'] = $instance = new \App\Command\GetAllFreelancerCommand(new \App\Service\GulpScraper(($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()), ($this->services['messenger.default_bus'] ?? $this->getMessenger_DefaultBusService()), ($this->privates['App\\Service\\GulpClient'] ?? ($this->privates['App\\Service\\GulpClient'] = new \App\Service\GulpClient())), ($this->privates['App\\MessageBus\\MessageHandler\\GetFreelancerDetailsMessageHandler'] ?? $this->getGetFreelancerDetailsMessageHandlerService())));
    ...
    /**
     * Gets the private 'App\MessageBus\MessageHandler\GetFreelancerDetailsMessageHandler' shared autowired service.
     *
     * @return \App\MessageBus\MessageHandler\GetFreelancerDetailsMessageHandler
     */
    protected function getGetFreelancerDetailsMessageHandlerService()
    {
        return $this->privates['App\\MessageBus\\MessageHandler\\GetFreelancerDetailsMessageHandler'] = new \App\MessageBus\MessageHandler\GetFreelancerDetailsMessageHandler(($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()), ($this->privates['App\\Service\\GulpClient'] ?? ($this->privates['App\\Service\\GulpClient'] = new \App\Service\GulpClient())));
    }
